...
const About = () => {
  return (
    <section id="about" className="min-h-screen bg-black text-white px-10 py-20 flex flex-col md:flex-row justify-center items-center gap-16">
      ...
      <div className="flex-1 fade-slide">
        ...
        <p className="text-gray-300 mt-1">
          ...
          Impact College of Engineering & Applied Sciences, Bengaluru <br />
