...
const Contact = () => {
  return (
    <section
      id="contact"
      className="min-h-screen bg-black text-white px-10 py-24 text-center relative overflow-hidden"
    >
      ...
      <p className="text-green-400 text-lg mb-10">
      ...
      <form className="max-w-xl mx-auto mt-8 space-y-5 fade-slide">
        ...
        <button className="w-full py-3 bg-green-500 text-black font-semibold rounded-full btn-glow">
          SUBMIT
        </button>
      </form>
    </section>
